...
- **Flutter** é um **framework de código aberto**, criado e mantido pelo **Google**.
    
- Ele é utilizado principalmente para **criar interfaces de usuário (UI)**.
    
- O Flutter é **multiplataforma**, ou seja, permite criar um único código que pode ser executado em:
    ...
    - E até em **dispositivos embarcados**, dependendo do suporte
        

>  Em resumo: você escreve o código uma vez e pode rodar em várias plataformas diferentes.
...
- Significa desenvolver **especificamente para uma única plataforma**.
...
- Significa criar um único aplicativo que funciona em várias plataformas.
    
- Com frameworks como o **Flutter**, você:
...
Mesmo utilizando Flutter, às vezes é necessário acessar **funcionalidades específicas de uma plataforma nativa**. Nesses casos, existe uma solução:

### Platform Channels (Canais de Plataforma)

- São **métodos de comunicação entre o código Flutter e o código nativo**.
    
- Permitem que o Flutter:
